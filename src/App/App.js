...
const settings = {
  name: 'React + Material-UI with Login'
};
...
class App extends Component {
  ...
  signUp = (emailAddress, password, passwordConfirmation) => {
    ...
    this.setState({
      ...
      this.createUser(emailAddress, password).then((value) => {
  ...
  signIn = (emailAddress, password) => {
    ...
    this.setState({
      ...
      fetch(`https://codebine.com/Fakeauth`, {
        method: "POST",
  ...
  resetPassword = (emailAddress) => {
    ...
    this.setState({
      ...
      this.sendPasswordResetEmail(emailAddress).then(() => {
